...
public class GTLOS {
    ...
    public static final String MOD_ID = "gtlos";
    public static final Logger LOGGER = LogManager.getLogger();
    public static final GTRegistrate REGISTRATE = GTRegistrate.create(GTLOS.MOD_ID);
    ...
    private void addMaterialRegistries(MaterialRegistryEvent event) {
        GTCEuAPI.materialManager.createRegistry(GTLOS.MOD_ID);
    }
